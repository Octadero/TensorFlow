...
// Source: tensorflow/contrib/makefile/downloads/protobuf/src/google/protobuf/unittest_well_known_types.proto
//
...
public struct ProtobufUnittest_TestWellKnownTypes {
  ...
  public var apiField: SwiftProtobuf.Google_Protobuf_Api {
  ...
  public var hasApiField: Bool {return _storage._apiField != nil}
  /// Clears the value of `apiField`. Subsequent reads from it will return its default value.
  public mutating func clearApiField() {_storage._apiField = nil}

  public var durationField: SwiftProtobuf.Google_Protobuf_Duration {
  ...
  public var hasDurationField: Bool {return _storage._durationField != nil}
  /// Clears the value of `durationField`. Subsequent reads from it will return its default value.
  public mutating func clearDurationField() {_storage._durationField = nil}

  public var emptyField: SwiftProtobuf.Google_Protobuf_Empty {
  ...
  public var hasEmptyField: Bool {return _storage._emptyField != nil}
  /// Clears the value of `emptyField`. Subsequent reads from it will return its default value.
  public mutating func clearEmptyField() {_storage._emptyField = nil}

  public var fieldMaskField: SwiftProtobuf.Google_Protobuf_FieldMask {
  ...
  public var hasFieldMaskField: Bool {return _storage._fieldMaskField != nil}
  /// Clears the value of `fieldMaskField`. Subsequent reads from it will return its default value.
  public mutating func clearFieldMaskField() {_storage._fieldMaskField = nil}

  public var sourceContextField: SwiftProtobuf.Google_Protobuf_SourceContext {
  ...
  public var hasSourceContextField: Bool {return _storage._sourceContextField != nil}
  /// Clears the value of `sourceContextField`. Subsequent reads from it will return its default value.
  public mutating func clearSourceContextField() {_storage._sourceContextField = nil}

  public var structField: SwiftProtobuf.Google_Protobuf_Struct {
  ...
  public var hasStructField: Bool {return _storage._structField != nil}
  /// Clears the value of `structField`. Subsequent reads from it will return its default value.
  public mutating func clearStructField() {_storage._structField = nil}

  public var timestampField: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasTimestampField: Bool {return _storage._timestampField != nil}
  /// Clears the value of `timestampField`. Subsequent reads from it will return its default value.
  public mutating func clearTimestampField() {_storage._timestampField = nil}

  public var typeField: SwiftProtobuf.Google_Protobuf_Type {
  ...
  public var hasTypeField: Bool {return _storage._typeField != nil}
  /// Clears the value of `typeField`. Subsequent reads from it will return its default value.
  public mutating func clearTypeField() {_storage._typeField = nil}

  public var doubleField: SwiftProtobuf.Google_Protobuf_DoubleValue {
  ...
  public var hasDoubleField: Bool {return _storage._doubleField != nil}
  /// Clears the value of `doubleField`. Subsequent reads from it will return its default value.
  public mutating func clearDoubleField() {_storage._doubleField = nil}

  public var floatField: SwiftProtobuf.Google_Protobuf_FloatValue {
  ...
  public var hasFloatField: Bool {return _storage._floatField != nil}
  /// Clears the value of `floatField`. Subsequent reads from it will return its default value.
  public mutating func clearFloatField() {_storage._floatField = nil}

  public var int64Field: SwiftProtobuf.Google_Protobuf_Int64Value {
  ...
  public var hasInt64Field: Bool {return _storage._int64Field != nil}
  /// Clears the value of `int64Field`. Subsequent reads from it will return its default value.
  public mutating func clearInt64Field() {_storage._int64Field = nil}

  public var uint64Field: SwiftProtobuf.Google_Protobuf_UInt64Value {
  ...
  public var hasUint64Field: Bool {return _storage._uint64Field != nil}
  /// Clears the value of `uint64Field`. Subsequent reads from it will return its default value.
  public mutating func clearUint64Field() {_storage._uint64Field = nil}

  public var int32Field: SwiftProtobuf.Google_Protobuf_Int32Value {
  ...
  public var hasInt32Field: Bool {return _storage._int32Field != nil}
  /// Clears the value of `int32Field`. Subsequent reads from it will return its default value.
  public mutating func clearInt32Field() {_storage._int32Field = nil}

  public var uint32Field: SwiftProtobuf.Google_Protobuf_UInt32Value {
  ...
  public var hasUint32Field: Bool {return _storage._uint32Field != nil}
  /// Clears the value of `uint32Field`. Subsequent reads from it will return its default value.
  public mutating func clearUint32Field() {_storage._uint32Field = nil}

  public var boolField: SwiftProtobuf.Google_Protobuf_BoolValue {
  ...
  public var hasBoolField: Bool {return _storage._boolField != nil}
  /// Clears the value of `boolField`. Subsequent reads from it will return its default value.
  public mutating func clearBoolField() {_storage._boolField = nil}

  public var stringField: SwiftProtobuf.Google_Protobuf_StringValue {
  ...
  public var hasStringField: Bool {return _storage._stringField != nil}
  /// Clears the value of `stringField`. Subsequent reads from it will return its default value.
  public mutating func clearStringField() {_storage._stringField = nil}

  public var bytesField: SwiftProtobuf.Google_Protobuf_BytesValue {
  ...
  public var hasBytesField: Bool {return _storage._bytesField != nil}
  /// Clears the value of `bytesField`. Subsequent reads from it will return its default value.
  public mutating func clearBytesField() {_storage._bytesField = nil}

  /// Part of struct, but useful to be able to test separately
  public var valueField: SwiftProtobuf.Google_Protobuf_Value {
  ...
  public var hasValueField: Bool {return _storage._valueField != nil}
  /// Clears the value of `valueField`. Subsequent reads from it will return its default value.
  public mutating func clearValueField() {_storage._valueField = nil}
...
public struct ProtobufUnittest_RepeatedWellKnownTypes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct ProtobufUnittest_OneofWellKnownTypes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_OneofField: Equatable {
    ...
    public static func ==(lhs: ProtobufUnittest_OneofWellKnownTypes.OneOf_OneofField, rhs: ProtobufUnittest_OneofWellKnownTypes.OneOf_OneofField) -> Bool {
      switch (lhs, rhs) {
...
public struct ProtobufUnittest_MapWellKnownTypes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var anyField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Any> {
    get {return _storage._anyField}
    set {_uniqueStorage()._anyField = newValue}
  }

  public var apiField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Api> {
    get {return _storage._apiField}
    set {_uniqueStorage()._apiField = newValue}
  }

  public var durationField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Duration> {
    get {return _storage._durationField}
    set {_uniqueStorage()._durationField = newValue}
  }

  public var emptyField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Empty> {
    get {return _storage._emptyField}
    set {_uniqueStorage()._emptyField = newValue}
  }

  public var fieldMaskField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_FieldMask> {
    get {return _storage._fieldMaskField}
    set {_uniqueStorage()._fieldMaskField = newValue}
  }

  public var sourceContextField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_SourceContext> {
    get {return _storage._sourceContextField}
    set {_uniqueStorage()._sourceContextField = newValue}
  }

  public var structField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Struct> {
    get {return _storage._structField}
    set {_uniqueStorage()._structField = newValue}
  }

  public var timestampField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Timestamp> {
    get {return _storage._timestampField}
    set {_uniqueStorage()._timestampField = newValue}
  }

  public var typeField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Type> {
    get {return _storage._typeField}
    set {_uniqueStorage()._typeField = newValue}
  }

  public var doubleField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_DoubleValue> {
    get {return _storage._doubleField}
    set {_uniqueStorage()._doubleField = newValue}
  }

  public var floatField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_FloatValue> {
    get {return _storage._floatField}
    set {_uniqueStorage()._floatField = newValue}
  }

  public var int64Field: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Int64Value> {
    get {return _storage._int64Field}
    set {_uniqueStorage()._int64Field = newValue}
  }

  public var uint64Field: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_UInt64Value> {
    get {return _storage._uint64Field}
    set {_uniqueStorage()._uint64Field = newValue}
  }

  public var int32Field: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_Int32Value> {
    get {return _storage._int32Field}
    set {_uniqueStorage()._int32Field = newValue}
  }

  public var uint32Field: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_UInt32Value> {
    get {return _storage._uint32Field}
    set {_uniqueStorage()._uint32Field = newValue}
  }

  public var boolField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_BoolValue> {
    get {return _storage._boolField}
    set {_uniqueStorage()._boolField = newValue}
  }

  public var stringField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_StringValue> {
    get {return _storage._stringField}
    set {_uniqueStorage()._stringField = newValue}
  }

  public var bytesField: Dictionary<Int32,SwiftProtobuf.Google_Protobuf_BytesValue> {
    get {return _storage._bytesField}
    set {_uniqueStorage()._bytesField = newValue}
  }
...
extension ProtobufUnittest_TestWellKnownTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TestWellKnownTypes"
  ...
  public func _protobuf_generated_isEqualTo(other: ProtobufUnittest_TestWellKnownTypes) -> Bool {
...
extension ProtobufUnittest_RepeatedWellKnownTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RepeatedWellKnownTypes"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "any_field"),
    2: .standard(proto: "api_field"),
    3: .standard(proto: "duration_field"),
  ...
  public func _protobuf_generated_isEqualTo(other: ProtobufUnittest_RepeatedWellKnownTypes) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
...
extension ProtobufUnittest_OneofWellKnownTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".OneofWellKnownTypes"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "any_field"),
    2: .standard(proto: "api_field"),
    3: .standard(proto: "duration_field"),
  ...
  public func _protobuf_generated_isEqualTo(other: ProtobufUnittest_OneofWellKnownTypes) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
...
extension ProtobufUnittest_MapWellKnownTypes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MapWellKnownTypes"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "any_field"),
    2: .standard(proto: "api_field"),
    3: .standard(proto: "duration_field"),
  ...
  public func _protobuf_generated_isEqualTo(other: ProtobufUnittest_MapWellKnownTypes) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
