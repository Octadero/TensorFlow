...
extension Tensorflow_SessionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Tensorflow_SessionInfo) -> Bool {
    if self.intraOpParallelism != other.intraOpParallelism {return false}
...
extension Tensorflow_OpPerformance.OpMemory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Tensorflow_OpPerformance.OpMemory) -> Bool {
    ...
    if self.tempMemory != other.tempMemory {return false}
    if self.persistentMemory != other.persistentMemory {return false}
